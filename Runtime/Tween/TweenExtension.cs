...
public static class TweenExtension
{
    ...
    public static Sequence ShakeScaleAtSpeed(this Transform obj, Vector3 vibrato, int shakeCount = 8, float speed = 5f,
        bool fadeOut = false)
    {
        return Tween.Instance.ShakeScaleAtSpeed(obj, vibrato, shakeCount, speed);
    }

    public static Sequence ShakeScaleAtSpeed(this GameObject obj, Vector3 vibrato, int shakeCount = 8, float speed = 5f,
        bool fadeOut = false)
    {
        return Tween.Instance.ShakeScaleAtSpeed(obj, vibrato, shakeCount, speed);
    }
