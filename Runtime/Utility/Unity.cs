...
namespace F8Framework.Core
{
    public static partial class Util
    {
        ...
        public static class Unity
        {
            ...
            {
                return originalTexture.ScaleTextureBilinear(scaleFactor);
            }
            ...
            {
                return originalTexture.SizeTextureBilinear(size);
            }
            ...
            {
                return texture.RotateTexture(eulerAngles);
            }
